...
while True:
    user = api.get_user('Vishal00709510')
    api.update_profile(name=f'vishal |{follower_count(user)} Followers')
    print(f'Updating Twitter Name : vishal |{follower_count(user)} Followers')
